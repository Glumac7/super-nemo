...
Common options:
  ...
  --dry-run               install/uninstall: print the plan, write nothing; update: fetch and list new commits only
...
const OPTIONS = {
  install: ["yes", "reuse", "impl", "fast", "advisor", "advisor-critical", "review", "approval", "overwrite-drift", "no-smoke", "dry-run"],
  update: ["dry-run", "overwrite-drift", "pull-only"],
  uninstall: ["dry-run"],
  status: [],
  verify: ["smoke"],
};
